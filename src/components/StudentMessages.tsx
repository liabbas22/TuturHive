  ...
  const conversations = [
    {
      ...
      lastMessage: 'Great question! The dependency array controls...',
      time: '2 hours ago',
      unread: 1
    },
    {
            ...
            <>
              ...
              <div className="p-4 border-b border-gray-200">
                <h3 className="text-lg font-medium text-gray-900">
                  {conversations.find(c => c.id === selectedChat)?.tutorName}
                </h3>
                  ...
                  >
                    ...
                    >
                      ...
                      <p className={`text-xs mt-1 ${
                        message.sender === 'student' ? 'text-yellow-100' : 'text-gray-500'
                      }`}>
                        {message.time}
                      </p>
                    </div>
